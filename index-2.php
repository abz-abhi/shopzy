    ...
    <main class="main">
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div class="banner-big banner-big-2 bg-15" style="background-image: url(assets/imgs/page/homepage2/bg-slide.png)"><span class="saleoff">-25%</span><span class="font-sm text-uppercase label-green">new arrival</span>
                          ...
                          <div class="mt-30"><a class="btn btn-brand-2 btn-gray-1000" href="shop-grid-2.php">Shop now</a><a class="btn btn-link btn-link-white" href="shop-grid-2.php">Learn more</a></div>
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div class="banner-big banner-big-2 bg-15" style="background-image: url(assets/imgs/page/homepage2/bg-slide-2.png)"><span class="saleoff">-25%</span><span class="font-sm text-uppercase label-green">Best Sale</span>
                          ...
                          <h1 class="color-white lh-65">KMSZ 14 2022</h1>
                          <div class="row">
                            <div class="col-lg-5 col-md-7 col-sm-12">
                              <ul class="list-disc">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                    <div class="banner-small banner-apple bg-2 text-center">
                      ...
                      <div class="mt-0"><a class="btn btn-link-orange" href="shop-grid-2.php">Shop Now</a></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                    <div class="banner-small banner-samsung bg-4"><span class="color-brand-3 font-md">New Arrivals</span>
                      <h4 class="mb-10 color-gray-1000">Samsung 2022 Led TV<span class="color-brand-3 font-md">Special sale</span></h4>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <ul class="list-9-col">
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-1.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Air Purifier</a>
                      ...
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-2.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Women Bags</a>
                      ...
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-3.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Bluetooth</a>
                      ...
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-4.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Electronic</a>
                            <p class="font-xs color-gray-500">1025 items</p>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-5.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Gaming Gear</a>
                            <p class="font-xs color-gray-500">1025 items</p>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-6.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Gaming Chair</a>
                            <p class="font-xs color-gray-500">1025 items</p>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-7.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Home App</a>
                            <p class="font-xs color-gray-500">1025 items</p>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-8.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Kitchen</a>
                            <p class="font-xs color-gray-500">1025 items</p>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-9.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Mobile Gadgets</a>
                            <p class="font-xs color-gray-500">1025 items</p>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-10.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Computers</a>
                      ...
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-11.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Outdoor Camera</a>
                            <p class="font-xs color-gray-500">1025 items</p>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-12.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Entertainment</a>
                      ...
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-13.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Sport</a>
                      ...
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-14.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Tablet</a>
                      ...
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-15.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Television</a>
                            <p class="font-xs color-gray-500">1025 items</p>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-16.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Watches</a>
                      ...
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-17.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Drone &amp; Flycam</a>
                      ...
                      <li>
                        <div class="box-category hover-up">
                          <div class="image"><a href="shop-grid-2.php"><img src="assets/imgs/page/homepage2/cat-img-18.png" alt="Ecom"></a></div>
                          <div class="text-info"><a class="font-sm color-gray-900 font-bold" href="shop-grid-2.php">Video &amp; Camera</a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="card-grid-style-3 hover-show hover-hide-show-cart">
                    <div class="card-grid-inner">
                      ...
                      <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="#">2022 Apple iMac with Retina 5K Display 8GB RAM, 256GB SSD</a>
                        <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500"> (65)</span></div>
                        <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                        <div class="box-progress box-progress-small">
                          <div class="progress-bar">
              ...
              <div class="list-products-5">
                <div class="card-grid-style-3 card-grid-none-border">
                  <div class="card-grid-inner">
                    ...
                    <div class="image-box"><span class="label bg-brand-2">-12%</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage1/imgsp3.png" alt="Ecom"></a>
                    </div>
                ...
                <div class="card-grid-style-3 card-grid-none-border">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-25%</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage1/imgsp5.png" alt="Ecom"></a>
                    </div>
                ...
                <div class="card-grid-style-3 card-grid-none-border">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-16%</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage1/imgsp6.png" alt="Ecom"></a>
                    </div>
                ...
                <div class="card-grid-style-3 card-grid-none-border">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-22%</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage1/imgsp7.png" alt="Ecom"></a>
                    </div>
                ...
                <div class="card-grid-style-3 card-grid-none-border">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-25%</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage1/imgsp1.png" alt="Ecom"></a>
                    </div>
                ...
                <div class="card-grid-style-3 card-grid-none-border">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-10%</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage1/imgsp4.png" alt="Ecom"></a>
                    </div>
                ...
                <div class="card-grid-style-3 card-grid-none-border">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-5%</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage1/imgsp6.png" alt="Ecom"></a>
                    </div>
          ...
          <div class="row">
            <div class="col-lg-3 mb-20">
              <div class="bg-4 box-bdrd-4 bg-headphone"><span class="font-md color-brand-3">Headphone</span>
                ...
                <div class="mt-35"><a class="btn btn-brand-2 btn-arrow-right" href="shop-grid-2.php">Shop Now</a></div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 mb-20">
              <div class="bg-5 box-bdrd-4 bg-ipad text-center"><span class="font-sm color-brand-3">New Arrivals</span>
                <h4 class="font-xl color-gray-1000">Certified Deals On<br class="d-none d-lg-block"><span class="color-brand-1">Surface Pro</span> 2022</h4>
                <div class="mt-15"><a class="btn btn-brand-2 btn-arrow-right" href="shop-grid-2.php">Shop Now</a></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="section-box mt-50">
        <div class="container">
          ...
          <div class="row mt-40">
            <div class="col-lg-6"><img src="assets/imgs/page/homepage2/ads-2.png" alt="Ecom"></div>
            <div class="col-lg-6"><img src="assets/imgs/page/homepage2/ads-3.png" alt="Ecom"></div>
          </div>
          <div class="row mt-60">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
              <div class="card-grid-style-2 card-grid-style-2-small">
                <div class="image-box"><a href="shop-fullwidth.html"><img src="assets/imgs/page/homepage1/smartphone.png" alt="Ecom"></a>
                ...
                <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-fullwidth.html">
                  ...
                  <ul class="list-links-disc">
                    <li><a class="font-sm" href="shop-fullwidth.html">Phone Accessories</a></li>
                    <li><a class="font-sm" href="shop-fullwidth.html">Phone Cases</a></li>
                    <li><a class="font-sm" href="shop-fullwidth.html">Postpaid Phones</a></li>
                    <li><a class="font-sm" href="shop-fullwidth.html">Refurbished Phones</a></li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
              <div class="card-grid-style-2 card-grid-style-2-small">
                <div class="image-box"><a href="shop-fullwidth.html"><img src="assets/imgs/page/homepage1/television.png" alt="Ecom"></a>
                  <div class="mt-10 text-center"><a class="btn btn-gray" href="shop-fullwidth.html">View all</a></div>
                </div>
                <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-fullwidth.html">
                    <h6>Television</h6></a>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
              <div class="card-grid-style-2 card-grid-style-2-small">
                <div class="image-box"><a href="shop-fullwidth.html"><img src="assets/imgs/page/homepage1/computer.png" alt="Ecom"></a>
                  <div class="mt-10 text-center"><a class="btn btn-gray" href="shop-fullwidth.html">View all</a></div>
                </div>
                <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-fullwidth.html">
                    <h6>Computers</h6></a>
                  <ul class="list-links-disc">
                    <li><a class="font-sm" href="shop-fullwidth.html">Computer Components</a></li>
                    <li><a class="font-sm" href="shop-fullwidth.html">Computer Accessories</a></li>
                    <li><a class="font-sm" href="shop-fullwidth.html">Desktops</a></li>
                    <li><a class="font-sm" href="shop-fullwidth.html">Monitors</a></li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
              <div class="card-grid-style-2 card-grid-style-2-small">
                <div class="image-box"><a href="shop-fullwidth.html"><img src="assets/imgs/page/homepage1/electric.png" alt="Ecom"></a>
                  <div class="mt-10 text-center"><a class="btn btn-gray" href="shop-fullwidth.html">View all</a></div>
                </div>
                <div class="info-right"><a class="color-brand-3 font-sm-bold" href="shop-fullwidth.html">
                    <h6>Electronics</h6></a>
                  <ul class="list-links-disc">
                    <li><a class="font-sm" href="shop-fullwidth.html">Office Electronics</a></li>
                    <li><a class="font-sm" href="shop-fullwidth.html">Portable Audio &amp; Video</a></li>
                    <li><a class="font-sm" href="shop-fullwidth.html">Washing Machine</a></li>
                    <li><a class="font-sm" href="shop-fullwidth.html">Accessories &amp; Supplies</a></li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="card-grid-style-4">
                    <div class="card-grid-inner">
                      <div class="image-box"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/img-microsoft.png" alt="Ecom"></a></div>
                      <div class="info-right"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/microsoft.svg" alt="Ecom"></a>
                        ...
                        <div class="box-link"><a class="btn btn-link-brand-2 btn-arrow-brand-2 btn-arrow-small text-lowercase pt-0 pb-0" href="shop-vendor-single.html">Shop Now</a></div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="card-grid-style-4">
                    <div class="card-grid-inner">
                      <div class="image-box"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/img-nokia.png" alt="Ecom"></a></div>
                      <div class="info-right"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/nokia.svg" alt="Ecom"></a>
                        <p class="font-xs color-brand-3">PC, Laptop, Smart Watch, Gaming Gear ...</p>
                        <div class="divide mb-5"></div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="card-grid-style-4">
                    <div class="card-grid-inner">
                      <div class="image-box"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/img-panasonic.png" alt="Ecom"></a></div>
                      <div class="info-right"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/panasonic.svg" alt="Ecom"></a>
                        <p class="font-xs color-brand-3">PC, Laptop, Smart Watch, Gaming Gear ...</p>
                        <div class="divide mb-5"></div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="card-grid-style-4">
                    <div class="card-grid-inner">
                      <div class="image-box"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/img-sharp.png" alt="Ecom"></a></div>
                      <div class="info-right"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/sharp.svg" alt="Ecom"></a>
                        <p class="font-xs color-brand-3">PC, Laptop, Smart Watch, Gaming Gear ...</p>
                        <div class="divide mb-5"></div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="card-grid-style-4">
                    <div class="card-grid-inner">
                      <div class="image-box"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/img-philip.png" alt="Ecom"></a></div>
                      <div class="info-right"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/philip.svg" alt="Ecom"></a>
                        <p class="font-xs color-brand-3">PC, Laptop, Smart Watch, Gaming Gear ...</p>
                        <div class="divide mb-5"></div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="card-grid-style-4">
                    <div class="card-grid-inner">
                      <div class="image-box"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/img-casio.png" alt="Ecom"></a></div>
                      <div class="info-right"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/casio.svg" alt="Ecom"></a>
                        <p class="font-xs color-brand-3">PC, Laptop, Smart Watch, Gaming Gear ...</p>
                        <div class="divide mb-5"></div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="card-grid-style-4">
                    <div class="card-grid-inner">
                      <div class="image-box"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/img-acer.png" alt="Ecom"></a></div>
                      <div class="info-right"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/acer.svg" alt="Ecom"></a>
                        <p class="font-xs color-brand-3">PC, Laptop, Smart Watch, Gaming Gear ...</p>
                        <div class="divide mb-5"></div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
                  <div class="card-grid-style-4">
                    <div class="card-grid-inner">
                      <div class="image-box"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/img-toshiba.png" alt="Ecom"></a></div>
                      <div class="info-right"><a href="shop-vendor-single.html"><img src="assets/imgs/page/homepage2/toshiba.svg" alt="Ecom"></a>
                        <p class="font-xs color-brand-3">PC, Laptop, Smart Watch, Gaming Gear ...</p>
                        <div class="divide mb-5"></div>
                      ...
                      <div class="swiper-wrapper pt-5">
                        <div class="swiper-slide">
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/camera.png" alt="Ecom"></a>
                            </div>
                          ...
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/clock.png" alt="Ecom"></a>
                            </div>
                          ...
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/airpod.png" alt="Ecom"></a>
                            </div>
                        ...
                        <div class="swiper-slide">
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/airpod.png" alt="Ecom"></a>
                            </div>
                            <div class="info-right"><span class="font-xs color-gray-500">Razer</span><br><a class="color-brand-3 font-xs-bold" href="shop-single-product-2.php">Razer Power Up Gaming Bundle V2 - Cynosa Lite</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500"> (65)</span></div>
                              <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2556.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                          ...
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/camera.png" alt="Ecom"></a>
                            </div>
                            <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-xs-bold" href="shop-single-product-2.php">Apple AirPods Pro with MagSafe Charging Case</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500"> (65)</span></div>
                              <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2556.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                  ...
                  <div class="box-swiper">
                    <div class="swiper-container swiper-featured">
                      <div class="swiper-wrapper pt-5">
                        <div class="swiper-slide">
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/cat-img-1.png" alt="Ecom"></a>
                            </div>
                          ...
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/cat-img-2.png" alt="Ecom"></a>
                            </div>
                          ...
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/cat-img-3.png" alt="Ecom"></a>
                            </div>
                  ...
                  <div class="box-swiper">
                    <div class="swiper-container swiper-mostviewed">
                      <div class="swiper-wrapper pt-5">
                        <div class="swiper-slide">
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/cat-img-4.png" alt="Ecom"></a>
                            </div>
                            <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-xs-bold" href="shop-single-product-2.php">2022 Apple 10.9-inch iPad Air Wi-Fi 64GB - Silver</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500"> (65)</span></div>
                              <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2556.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                            </div>
                          </div>
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/cat-img-6.png" alt="Ecom"></a>
                            </div>
                          ...
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/cat-img-7.png" alt="Ecom"></a>
                            </div>
                  ...
                  <div class="box-swiper">
                    <div class="swiper-container swiper-trending">
                      <div class="swiper-wrapper pt-5">
                        <div class="swiper-slide">
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/cat-img-8.png" alt="Ecom"></a>
                            </div>
                          ...
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/cat-img-5.png" alt="Ecom"></a>
                            </div>
                          ...
                          <div class="card-grid-style-2 card-grid-none-border hover-up">
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage2/cat-img-9.png" alt="Ecom"></a>
                            </div>
      ...
      <section class="section-box mt-50">
        <div class="container">       
          <div class="text-center mt-30"><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage2/banner-ads.png" alt="Ecom"></a></div>
        </div>
      </section>
      <section class="section-box mt-50">
        <div class="container">
