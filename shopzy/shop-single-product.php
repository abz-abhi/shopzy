            ...
            <div class="row align-items-end">
              <div class="col-lg-4 col-md-4 mb-20">
                <span class="font-sm font-medium color-gray-900"
                  >SKU:<span class="color-gray-500">iphone12pro128</span
                  ><br />Category:<span class="color-gray-500">Smartphones</span
                  ><br />Tags:<span class="color-gray-500"
                    >Blue, Smartphone</span
                  ></span
                >
              </div>
              <div class="col-lg-4 col-md-4 mb-20">
                <span class="font-sm font-medium color-gray-900"
                  >Free Delivery<br /><span class="color-gray-500"
                    >Available for all locations.</span
                  ><br /><span class="color-gray-500"
                    >Delivery Options & Info</span
                  ></span
                >
              </div>
