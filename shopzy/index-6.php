            ...
            <div class="row">
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-20">
                <div class="banner-small bg-5 text-center"><span class="color-brand-3 font-sm">New Arrivals</span>
                  ...
                  <div class="mt-20"><a class="btn btn-brand-3 btn-arrow-right" href="shop-grid.php">Shop Now</a></div>
              ...
              <div class="box-category-left">
                <div class="box-menu-category bg-white"> 
                  ...
                  <ul class="list-nav-arrow">
                    <li><a href="shop-grid.php">Monitors & Projects</a></li>
                    <li><a href="shop-grid.php">Screen Protectors</a></li>
                    <li><a href="shop-grid.php">Computers & Tablets</a></li>
                    <li><a href="shop-grid.php">Data Storage</a></li>
                    <li><a href="shop-grid.php">Laptop Accessories</a></li>
                    <li><a href="shop-grid.php">Networking Products</a></li>
                    <li><a href="shop-grid.php">Tablet Accessories</a></li>
                    <li><a href="shop-grid.php">Camera Privacy Covers</a></li>
                    <li><a href="shop-grid.php">Chargers & Adapters</a></li>
                  </ul>
                </div>
              </div>
            ...
            <div class="d-flex">
              <div class="box-category-left">
                <div class="box-menu-category bg-white"> 
                  ...
                  <ul class="list-nav-arrow">
                    <li><a href="shop-grid.php">Camera & Photo</a></li>
                    <li><a href="shop-grid.php">Vehicle Electronics</a></li>
                    <li><a href="shop-grid.php">Electronic Equipment</a></li>
                    <li><a href="shop-grid.php">GPS, Finders & Accessories</a></li>
                    <li><a href="shop-grid.php">Home Audio & Theater</a></li>
                    <li><a href="shop-grid.php">Office Electronics</a></li>
                    <li><a href="shop-grid.php">Portable Audio & Video</a></li>
                    <li><a href="shop-grid.php">Wearable Technology</a></li>
                    <li><a href="shop-grid.php">Power Accessories</a></li>
                  </ul>
                </div>
              </div>
              <div class="box-category-right">
            ...
            <div class="d-flex">
              <div class="box-category-left">
                <div class="box-menu-category bg-white"> 
                  ...
                  <ul class="list-nav-arrow">
                    <li><a href="shop-grid.php">Sofas & Couches</a></li>
                    <li><a href="shop-grid.php">Living Room Tables</a></li>
                    <li><a href="shop-grid.php">Living Room Furniture</a></li>
                    <li><a href="shop-grid.php">Dressers & Chests</a></li>
                    <li><a href="shop-grid.php">Beds, Frames & Bases</a></li>
                    <li><a href="shop-grid.php">Patio Conversation Sets</a></li>
                    <li><a href="shop-grid.php">Living Room Tables</a></li>
                    <li><a href="shop-grid.php">Chaise Lounges</a></li>
                    <li><a href="shop-grid.php">TV & Media Furniture</a></li>
                  </ul>
                </div>
              </div>
              <div class="box-category-right">
            ...
            <div class="d-flex">
              <div class="box-category-left">
                <div class="box-menu-category bg-white"> 
                  ...
                  <ul class="list-nav-arrow">
                    <li><a href="shop-grid.php">Gardening Hand Tools</a></li>
                    <li><a href="shop-grid.php">Power Tool Parts</a></li>
                    <li><a href="shop-grid.php">Tool Organizers</a></li>
                    <li><a href="shop-grid.php">Shop Wet Dry Vacuums</a></li>
                    <li><a href="shop-grid.php">Air Tools & Compressors</a></li>
                    <li><a href="shop-grid.php">Safety & Security</a></li>
                    <li><a href="shop-grid.php">Measuring & Layout Tools</a></li>
                    <li><a href="shop-grid.php">Storage & Organization</a></li>
                    <li><a href="shop-grid.php">Wet Dry Vacuums</a></li>
                  </ul>
                </div>
              </div>
              <div class="box-category-right">
