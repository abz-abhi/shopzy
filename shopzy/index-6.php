      ...
      <div class="container">
        <div class="box-inner-quickmenu">
          <ul>
            ...
            <li><a href="#">12 Days of Deals</a></li>
            <li><a href="#">Customer Service</a></li>
            <li><a href="#">Gift Cards</a></li>
            <li><a href="#">Dressers</a></li>
            <li><a href="#">Patio Sofas</a></li>
            ...
            <div class="row">
                      ...
                      <div class="swiper-slide">
                        <div class="banner-big-home9 bg-2">
                          <div class="info-banner"><span class="font-sm text-uppercase label-green">new arrival</span>
                            <h4 class="mt-10 color-gray-1000">Super discount for<br class="d-none d-lg-block">your first purchase</h4>
                            <p class="font-nd color-brand-1">Use discount code in checkout page.</p>
                            <div class="mt-30"><a class="btn btn-brand-2 btn-arrow-right" href="shop-grid-2.php">Shop now</a></div>
                          </div>
                          <div class="box-img-banner"><img src="assets/imgs/page/homepage9/banner.png" alt="Ecom"></div>
                        </div>
                      </div>
                      <div class="swiper-slide">
                        <div class="banner-big-home9 bg-2">
                          <div class="info-banner"><span class="font-sm text-uppercase label-green">new arrival</span>
                            <h4 class="mt-10 color-gray-1000">Super discount for<br class="d-none d-lg-block">your first purchase</h4>
                            <p class="font-md color-brand-1">Use discount code in checkout page.</p>
                            <div class="mt-30"><a class="btn btn-brand-2 btn-arrow-right" href="shop-grid-2.php">Shop now</a></div>
                          </div>
                          <div class="box-img-banner"><img src="assets/imgs/page/homepage9/banner.png" alt="Ecom"></div>
                        </div>
              ...
              <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-20">
                <div class="banner-small bg-5 text-center"><span class="color-brand-3 font-sm">New Arrivals</span>
                  <h4 class="mb-5 mt-5 color-gray-1000">Weekly Deal</h4><span class="color-brand-1 font-md">Up to<span class="color-brand-2 font-md font-bold">$252.00</span><span class="color-brand-3 font-md">OFF</span></span>
                  <div class="mt-20"><a class="btn btn-brand-3 btn-arrow-right" href="shop-grid-2.php">Shop Now</a></div>
                  <div class="mt-30"><img src="assets/imgs/page/homepage9/weekly.png" alt="Ecom"></div>
                </div>
              </div>
              <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-20">
                <div class="banner-small bg-30 text-center"><span class="color-brand-3 font-sm">New Arrivals</span>
                  ...
                  <div class="mt-10"><img src="assets/imgs/page/homepage9/certify.png" alt="Ecom"></div>
                </div>
              </div>
            </div>
          </div>
                      ...
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp1.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                        ...
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp2.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                        ...
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp3.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                  ...
                  <div class="box-swiper">
                    <div class="swiper-container swiper-group-3-bestselling">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp4.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                        ...
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp5.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                        ...
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp6.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                  ...
                  <div class="box-swiper">
                    <div class="swiper-container swiper-group-3-hotdeal">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp7.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                        ...
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp8.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                        ...
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp9.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                  ...
                  <div class="box-swiper">
                    <div class="swiper-container swiper-group-3-topranking">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp10.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                        ...
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp11.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                        ...
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp12.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                  ...
                  <div class="box-swiper">
                    <div class="swiper-container swiper-group-3-dropshipping">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp13.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                        ...
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp14.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                        ...
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp15.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                  ...
                  <div class="box-swiper">
                    <div class="swiper-container swiper-group-3-upcoming">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp16.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                        ...
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp17.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
                        ...
                        <div class="swiper-slide">
                          <div class="card-product-small"> 
                            <div class="card-image"> <a href="#"> <img src="assets/imgs/page/homepage9/sp18.png" alt="Ecom"></a></div>
                            <div class="card-info"> 
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                              <div class="box-prices"> 
                                <div class="price-bold color-brand-3">$2856.3</div>
            ...
            <div class="d-flex">
              <div class="box-category-left">
                <div class="box-menu-category bg-white"> 
                  <h5 class="title-border-bottom mb-20">Computers Accessories</h5>
                  <ul class="list-nav-arrow">
                    <li><a href="shop-grid-2.php">Monitors & Projects</a></li>
                    <li><a href="shop-grid-2.php">Screen Protectors</a></li>
                    <li><a href="shop-grid-2.php">Computers & Tablets</a></li>
                    <li><a href="shop-grid-2.php">Data Storage</a></li>
                    <li><a href="shop-grid-2.php">Laptop Accessories</a></li>
                    <li><a href="shop-grid-2.php">Networking Products</a></li>
                    <li><a href="shop-grid-2.php">Tablet Accessories</a></li>
                    <li><a href="shop-grid-2.php">Camera Privacy Covers</a></li>
                    <li><a href="shop-grid-2.php">Chargers & Adapters</a></li>
                  </ul>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        ...
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage1/imgsp7.png" alt="Ecom"></a>
                        </div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-danger">Hot</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage1/imgsp3.png" alt="Ecom"></a>
                        </div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-info">Deal</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage1/imgsp6.png" alt="Ecom"></a>
                        </div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-danger">Hot</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage1/imgsp5.png" alt="Ecom"></a>
                        </div>
            ...
            <div class="row">
              <div class="col-xl-4 col-lg-7 col-md-7 col-sm-12 mb-30">
                <div class="bg-4 block-charge"><span class="color-brand-3 font-sm-lh32">Power Bank</span>
                  ...
                  <p class="font-base color-brand-3 mb-20">Lightweight and Portable<br class="d-none d-lg-block"> Dual port fast charge</p><a class="btn btn-brand-2 btn-arrow-right" href="shop-fullwidth.html">Shop Now</a>
                </div>
              </div>
              <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12 mb-30">
                <div class="bg-6 block-player">
                  ...
                  <div class="mb-30"><strong class="font-16">Replacement Kit D-pad ABXY Keys</strong></div><a class="btn btn-brand-3 btn-arrow-right" href="shop-fullwidth.html">learn more</a>
                </div>
              </div>
              <div class="col-xl-3 col-lg-5 col-md-5 col-sm-12 mb-30">
                <div class="bg-5 block-iphone"><span class="color-brand-3 font-sm-lh32">Starting from $899</span>
                  <h3 class="font-xl mb-10">iPhone 12 Pro 128Gb</h3>
                  <p class="font-base color-brand-3 mb-10">Special Sale</p><a class="btn btn-arrow" href="shop-fullwidth.html">learn more</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="d-flex">
              <div class="box-category-left">
                <div class="box-menu-category bg-white"> 
                  ...
                  <ul class="list-nav-arrow">
                    <li><a href="shop-grid-2.php">Camera & Photo</a></li>
                    <li><a href="shop-grid-2.php">Vehicle Electronics</a></li>
                    <li><a href="shop-grid-2.php">Electronic Equipment</a></li>
                    <li><a href="shop-grid-2.php">GPS, Finders & Accessories</a></li>
                    <li><a href="shop-grid-2.php">Home Audio & Theater</a></li>
                    <li><a href="shop-grid-2.php">Office Electronics</a></li>
                    <li><a href="shop-grid-2.php">Portable Audio & Video</a></li>
                    <li><a href="shop-grid-2.php">Wearable Technology</a></li>
                    <li><a href="shop-grid-2.php">Power Accessories</a></li>
                  </ul>
                </div>
              </div>
              <div class="box-category-right">
                <div class="row">
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage9/sp19.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.php">Wyze Cam v3 1080p HD Indoor/Outdoor</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                          <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-danger">Hot</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage9/sp20.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Sonos Ray Compact Soundbar with Wall Mount</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                          <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-info">Deal</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage9/sp21.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Universal Balance Hoverboard Electric Scooter</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                          <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-danger">Hot</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage9/sp22.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Inspire 7255e All-in-One InkJet Printer</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                          <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
              ...
              <div class="col-lg-4 mb-20">
                <div class="block-sale-1"> 
                  <div class="row"> 
                    ...
                    <div class="col-lg-4 col-sm-4 col-4"><img src="assets/imgs/page/homepage7/sale1.png" alt="Ecom"></div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 mb-20">
                <div class="block-sale-1 bg-4"> 
                  <div class="row"> 
                    ...
                    <div class="col-lg-4 col-sm-4 col-4"><img src="assets/imgs/page/homepage7/sale2.png" alt="Ecom"></div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 mb-20">
                <div class="block-sale-1 bg-10"> 
                  <div class="row"> 
                    ...
                    <div class="col-lg-4 col-sm-4 col-4"><img src="assets/imgs/page/homepage7/sale3.png" alt="Ecom"></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="container">
          <div class="box-product-category">
            <div class="d-flex">
              <div class="box-category-left">
                <div class="box-menu-category bg-white"> 
                  <h5 class="title-border-bottom mb-20">Furniture & Decor</h5>
                  <ul class="list-nav-arrow">
                    <li><a href="shop-grid-2.php">Sofas & Couches</a></li>
                    <li><a href="shop-grid-2.php">Living Room Tables</a></li>
                    <li><a href="shop-grid-2.php">Living Room Furniture</a></li>
                    <li><a href="shop-grid-2.php">Dressers & Chests</a></li>
                    <li><a href="shop-grid-2.php">Beds, Frames & Bases</a></li>
                    <li><a href="shop-grid-2.php">Patio Conversation Sets</a></li>
                    <li><a href="shop-grid-2.php">Living Room Tables</a></li>
                    <li><a href="shop-grid-2.php">Chaise Lounges</a></li>
                    <li><a href="shop-grid-2.php">TV & Media Furniture</a></li>
                  </ul>
                </div>
              </div>
              <div class="box-category-right">
                <div class="row">
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage9/sp23.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.php">Wyze Cam v3 1080p HD Indoor/Outdoor</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                          <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-danger">Hot</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage9/sp24.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Sonos Ray Compact Soundbar with Wall Mount</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                          <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-info">Deal</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage9/sp25.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Universal Balance Hoverboard Electric Scooter</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                          <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-danger">Hot</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage9/sp26.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Inspire 7255e All-in-One InkJet Printer</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                          <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
            ...
            <div class="d-flex">
              <div class="box-category-left">
                <div class="box-menu-category bg-white"> 
                  ...
                  <ul class="list-nav-arrow">
                    <li><a href="shop-grid-2.php">Gardening Hand Tools</a></li>
                    <li><a href="shop-grid-2.php">Power Tool Parts</a></li>
                    <li><a href="shop-grid-2.php">Tool Organizers</a></li>
                    <li><a href="shop-grid-2.php">Shop Wet Dry Vacuums</a></li>
                    <li><a href="shop-grid-2.php">Air Tools & Compressors</a></li>
                    <li><a href="shop-grid-2.php">Safety & Security</a></li>
                    <li><a href="shop-grid-2.php">Measuring & Layout Tools</a></li>
                    <li><a href="shop-grid-2.php">Storage & Organization</a></li>
                    <li><a href="shop-grid-2.php">Wet Dry Vacuums</a></li>
                  </ul>
                </div>
              </div>
              <div class="box-category-right">
                <div class="row">
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage9/sp27.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.php">Wyze Cam v3 1080p HD Indoor/Outdoor</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                          <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-danger">Hot</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage9/sp28.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Sonos Ray Compact Soundbar with Wall Mount</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                          <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-info">Deal</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage9/sp29.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Universal Balance Hoverboard Electric Scooter</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                          <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6"> 
                    <div class="card-grid-style-3">
                      <div class="card-grid-inner">
                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                        <div class="image-box"><span class="label bg-danger">Hot</span><a href="shop-single-product.php"><img src="assets/imgs/page/homepage9/sp30.png" alt="Ecom"></a>
                        </div>
                        <div class="info-right"><span class="font-xs color-gray-500">Apple</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Inspire 7255e All-in-One InkJet Printer</a>
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                          <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
        ...
        <section class="section-box mt-40">
          <div class="container">
            <div class="banner-ads-3"> 
              ...
              <p class="font-base color-gray-900 mb-10">Free shipping available for purchases more than $80.</p><a class="btn btn-brand-3">View Products </a>
            </div>
          </div>
        </section>
      </div>
            ...
            <div class="swiper-wrapper pt-5">
              <div class="swiper-slide">
                <div class="card-grid-style-1">
                  <div class="image-box"><a href="blog-single-2.html"></a><img src="assets/imgs/page/homepage8/news1.png" alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list.html">News</a><a class="color-gray-1100" href="blog-single-2.html">
                    <h4>Ten Reasons We're Wrong About the World</h4></a>
                  <div class="mt-20"><span class="color-gray-500 font-xs mr-30">August 30, 2022</span><span class="color-gray-500 font-xs">4<span> Mins read</span></span></div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="card-grid-style-1">
                  <div class="image-box"><a href="blog-single.html"></a><img src="assets/imgs/page/homepage8/news2.png" alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list.html">News</a><a class="color-gray-1100" href="blog-single.html">
                    <h4>How the Courage to Be Vulnerable Transforms</h4></a>
              ...
              <div class="swiper-slide">
                <div class="card-grid-style-1">
                  <div class="image-box"><a href="blog-single-3.html"></a><img src="assets/imgs/page/homepage8/news3.png" alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list.html">News</a><a class="color-gray-1100" href="blog-single-3.html">
                    <h4>Why Some Companies Make the Leap and Others</h4></a>
                  <div class="mt-20"><span class="color-gray-500 font-xs mr-30">August 30, 2022</span><span class="color-gray-500 font-xs">3<span> Mins read</span></span></div>
                </div>
              </div>
              <div class="swiper-slide">
                <div class="card-grid-style-1">
                  <div class="image-box"><a href="blog-single-2.html"></a><img src="assets/imgs/page/homepage8/news4.png" alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list.html">Tips</a><a class="color-gray-1100" href="blog-single-2.html">
                    <h4>The Art of Stress-Free Productivity</h4></a>
                  <div class="mt-20"><span class="color-gray-500 font-xs mr-30">August 30, 2022</span><span class="color-gray-500 font-xs">7<span> Mins read</span></span></div>
                </div>
              </div>
            </div>
          </div>
