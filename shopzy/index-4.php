<?php include('common/header.php') ?>
    ...
    <div class="sidebar-left"><a class="btn btn-open" href="#"></a>
      <ul class="menu-icons hidden">
        <li><a href="javascript:void(0)"><img src="assets/imgs/page/homepage6/armchair.svg" alt="Ecom"></a></li>
        <li><a href="javascript:void(0)"><img src="assets/imgs/page/homepage6/bathhub.svg" alt="Ecom"></a></li>
        <li><a href="#"><img src="assets/imgs/page/homepage6/bed.svg" alt="Ecom"></a></li>
        <li><a href="#"><img src="assets/imgs/page/homepage6/office.svg" alt="Ecom"></a></li>
        <li><a href="#"><img src="assets/imgs/page/homepage6/chair.svg" alt="Ecom"></a></li>
        <li><a href="#"><img src="assets/imgs/page/homepage6/chest.svg" alt="Ecom"></a></li>
        <li><a href="#"><img src="assets/imgs/page/homepage6/dressing.svg" alt="Ecom"></a></li>
        <li><a href="#"><img src="assets/imgs/page/homepage6/lamp.svg" alt="Ecom"></a></li>
        <li><a href="#"><img src="assets/imgs/page/homepage6/sofa.svg" alt="Ecom"></a></li>
        <li><a href="#"><img src="assets/imgs/page/homepage6/storage.svg" alt="Ecom"></a></li>
        <li><a href="#"><img src="assets/imgs/page/homepage6/electric.svg" alt="Ecom"></a></li>
        <li><a href="#"><img src="assets/imgs/page/homepage6/wardrobe.svg" alt="Ecom"></a></li>
      </ul>
          ...
          <div class="row">
            <div class="col-lg-3">
              <div class="banner-left">
                <div class="box-adsolute-banner">
                  <h5 class="color-gray-900">Office Collection</h5><a class="btn btn-link-brand-2 text-capitalize">Shop Now</a>
                </div>
              </div>
            </div>
                ...
                <div class="swiper-container swiper-banner-1">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="banner-middle" style="background-image: url(assets/imgs/page/homepage6/banner2.png)">
                        <div class="box-adsolute-banner">
                    ...
                    <div class="swiper-slide">
                      <div class="banner-middle" style="background-image: url(assets/imgs/page/homepage6/banner2-2.png)">
                        <div class="box-adsolute-banner">
                          <h6 class="color-gray-900 mb-10">Big & Fresh Offers</h6>
                          <h2 class="color-gray-1000 mb-5">DECORA & CRAFTS</h2>
                          <h6 class="sale-tag">Sale On This Weekend</h6>
            ...
            <div class="col-lg-3">
              <div class="banner-right-home6">
                <div class="box-adsolute-banner">
                  <h5 class="color-gray-900">Comfort Chair</h5><a class="btn btn-link-brand-2 text-capitalize">Shop Now</a>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="swiper-wrapper pt-5">
                  <div class="swiper-slide">
                    <div class="card-category">
                      <div class="card-image"><a href="#"><img src="assets/imgs/page/homepage6/living-room.png" alt="Ecom"></a></div>
                  ...
                  <div class="swiper-slide">
                    <div class="card-category">
                      <div class="card-image"><a href="#"><img src="assets/imgs/page/homepage6/reading-room.png" alt="Ecom"></a></div>
                      <div class="card-info"><a href="blog-single.html">
                  ...
                  <div class="swiper-slide">
                    <div class="card-category">
                      <div class="card-image"><a href="#"><img src="assets/imgs/page/homepage6/bed-room.png" alt="Ecom"></a></div>
                      <div class="card-info"><a href="blog-single.html">
                  ...
                  <div class="swiper-slide">
                    <div class="card-category">
                      <div class="card-image"><a href="#"><img src="assets/imgs/page/homepage6/kitchen.png" alt="Ecom"></a></div>
                      <div class="card-info"><a href="blog-single.html">
                  ...
                  <div class="swiper-slide">
                    <div class="card-category">
                      <div class="card-image"><a href="#"><img src="assets/imgs/page/homepage6/decoration.png" alt="Ecom"></a></div>
                      <div class="card-info"><a href="blog-single.html">
          ...
          <div class="head-main bd-gray-200">
            <div class="row">
              <div class="col-xl-6 col-lg-6">
                ...
                <p class="font-base color-gray-500">Shop living room furniture, crafted by designers all over the world</p>
              </div>
              <div class="col-xl-6 col-lg-6">
                      ...
                      <div class="list-products-5">
                        <div class="card-grid-style-3 home6-style">
                          <div class="card-grid-inner">
                            ...
                            <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage6/sp1.png" alt="Ecom"></a>
                            </div>
                        ...
                        <div class="card-grid-style-3 home6-style">
                          <div class="card-grid-inner">
                            <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                            <div class="image-box"><span class="label bg-danger">Hot</span><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage6/sp2.png" alt="Ecom"></a>
                            </div>
                        ...
                        <div class="card-grid-style-3 home6-style">
                          <div class="card-grid-inner">
                            <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                            <div class="image-box"><span class="label bg-success">New</span><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage6/sp3.png" alt="Ecom"></a>
                            </div>
                        ...
                        <div class="card-grid-style-3 home6-style">
                          <div class="card-grid-inner">
                            <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage6/sp4.png" alt="Ecom"></a>
                            </div>
                        ...
                        <div class="card-grid-style-3 home6-style">
                          <div class="card-grid-inner">
                            <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage6/sp5.png" alt="Ecom"></a>
                            </div>
                            <div class="info-right"><a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br><a class="color-brand-3 font-sm-bold" href="shop-single-product-2.php">MSI Optix G272 27&quot; Full HD LED Gaming LCD Monitor</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info mb-10"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                        ...
                        <div class="card-grid-style-3 home6-style">
                          <div class="card-grid-inner">
                            <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                            <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage6/sp6.png" alt="Ecom"></a>
                            </div>
                            <div class="info-right"><a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br><a class="color-brand-3 font-sm-bold" href="shop-single-product-2.php">HP 11.6&quot; Chromebook, AMD A4, 4GB RAM, 32GB Storage</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info mb-10"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                        ...
                        <div class="card-grid-style-3 home6-style">
                          <div class="card-grid-inner">
                            <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                            <div class="image-box"><span class="label bg-danger">Hot</span><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage6/sp7.png" alt="Ecom"></a>
                            </div>
                            <div class="info-right"><a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br><a class="color-brand-3 font-sm-bold" href="shop-single-product-2.php">ASUS VivoBook 15.6&quot; 1080p PC Laptops, Intel Core i3</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info mb-10"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                        ...
                        <div class="card-grid-style-3 home6-style">
                          <div class="card-grid-inner">
                            <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                            <div class="image-box"><span class="label bg-success">New</span><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage6/sp8.png" alt="Ecom"></a>
                            </div>
                            <div class="info-right"><a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br><a class="color-brand-3 font-sm-bold" href="shop-single-product-2.php">2020 Apple 10.9-inch iPad Air Wi-Fi 64GB - Silver</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info mb-10"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                        ...
                        <div class="card-grid-style-3 home6-style">
                          <div class="card-grid-inner">
                            <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage6/sp9.png" alt="Ecom"></a>
                            </div>
                            <div class="info-right"><a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br><a class="color-brand-3 font-sm-bold" href="shop-single-product-2.php">MSI Optix G272 27&quot; Full HD LED Gaming LCD Monitor</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info mb-10"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                        ...
                        <div class="card-grid-style-3 home6-style">
                          <div class="card-grid-inner">
                            <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                            <div class="image-box"><a href="shop-single-product-2.php"><img src="assets/imgs/page/homepage6/sp10.png" alt="Ecom"></a>
                            </div>
                            <div class="info-right"><a class="font-xs color-gray-500" href="shop-vendor-single.html">Apple</a><br><a class="color-brand-3 font-sm-bold" href="shop-single-product-2.php">MSI Optix G272 27&quot; Full HD LED Gaming LCD Monitor</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info mb-10"><strong class="font-lg-bold color-brand-3 price-main">$2856.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
          ...
          <div class="row">
            <div class="col-lg-6 mb-30">
              <div class="card-banner hover-up"> 
                <div class="card-image"><a href="#"> <img src="assets/imgs/page/homepage6/banner-bottom-1.png" alt="Ecom"></a></div>
            ...
            <div class="col-lg-6 mb-30">
              <div class="card-banner hover-up"> 
                <div class="card-image"> <a href="#"><img src="assets/imgs/page/homepage6/banner-bottom-2.png" alt="Ecom"></a></div>
                <div class="card-info mt-10 text-center"> <a href="#">
      ...
      <section class="section-box mt-50">
        <div class="container">
          <div class="row"> 
            ...
            <div class="col-lg-4">
              <div class="banner-bottom-3"> 
                <div class="banner-bottom-info top-style-2"> 
                  <h4 class="color-white mb-5">Top Rated Chair</h4>
                  <p class="font-base-2 color-white mb-20">Under $120</p><a class="btn btn-info btn-arrow-right">Shop Now</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              ...
              <div class="swiper-wrapper pt-5">
                <div class="swiper-slide">
                  <div class="card-grid-style-1">
                    <div class="image-box"><a href="blog-single-2.html"></a><img src="assets/imgs/page/homepage6/news1.png" alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list.html">News</a><a class="color-gray-1100" href="blog-single-2.html">
                ...
                <div class="swiper-slide">
                  <div class="card-grid-style-1">
                    <div class="image-box"><a href="blog-single.html"></a><img src="assets/imgs/page/homepage6/news2.png" alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list.html">News</a><a class="color-gray-1100" href="blog-single.html">
                ...
                <div class="swiper-slide">
                  <div class="card-grid-style-1">
                    <div class="image-box"><a href="blog-single-3.html"></a><img src="assets/imgs/page/homepage6/news3.png" alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list.html">News</a><a class="color-gray-1100" href="blog-single-3.html">
                ...
                <div class="swiper-slide">
                  <div class="card-grid-style-1">
                    <div class="image-box"><a href="blog-single-2.html"></a><img src="assets/imgs/page/homepage6/news4.png" alt="Ecom"></div><a class="tag-dot font-xs" href="blog-list.html">Tips</a><a class="color-gray-1100" href="blog-single-2.html">
