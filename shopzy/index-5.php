                        ...
                        <div class="banner-big bg-27 height-100">
                          <div class="row align-items-end height-100"> 
                            <div class="col-xl-8 col-lg-12 height-100 align-items-center d-flex">
                              <div class="box-banner-big"><span class="font-sm text-uppercase">Hot Right Now</span>
              ...
              <div class="list-products-5 list-brand-2">
                <div class="card-grid-style-3 card-style-full-image">
                  <div class="card-grid-inner">
                    ...
                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage8/sp1.png" alt="Ecom"></a>
                    </div>
                    <div class="info-right">
                      <div class="row"> 
                        <div class="col-6"> <span class="font-xs color-gray-500">Benjamin Graham</span></div>
                        <div class="col-6 text-end"> 
                          <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <img src="assets/imgs/template/icons/star.svg" alt="Ecom"> <span class="font-xs color-gray-500">(65)</span></div>
                        </div>
                      </div><a class="color-brand-3 font-sm-bold" href="shop-single-product-3.php">Start with Why: How Great Leaders Inspire Everyone to Take Action</a>
                ...
                <div class="card-grid-style-3 card-style-full-image">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage8/sp2.png" alt="Ecom"></a>
                    </div>
                    <div class="info-right">
                      <div class="row"> 
                        <div class="col-6"> <span class="font-xs color-gray-500">Benjamin Graham</span></div>
                ...
                <div class="card-grid-style-3 card-style-full-image">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage8/sp3.png" alt="Ecom"></a>
                    </div>
                    <div class="info-right">
                      <div class="row"> 
                        <div class="col-6"> <span class="font-xs color-gray-500">Benjamin Graham</span></div>
                ...
                <div class="card-grid-style-3 card-style-full-image">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage8/sp4.png" alt="Ecom"></a>
                    </div>
                    <div class="info-right">
                      <div class="row"> 
                        <div class="col-6"> <span class="font-xs color-gray-500">Benjamin Graham</span></div>
                ...
                <div class="card-grid-style-3 card-style-full-image">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage8/sp5.png" alt="Ecom"></a>
                    </div>
                    <div class="info-right">
                      <div class="row"> 
                        <div class="col-6"> <span class="font-xs color-gray-500">Benjamin Graham</span></div>
                ...
                <div class="card-grid-style-3 card-style-full-image">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage8/sp6.png" alt="Ecom"></a>
                    </div>
                    <div class="info-right">
                      <div class="row"> 
                        <div class="col-6"> <span class="font-xs color-gray-500">Benjamin Graham</span></div>
                ...
                <div class="card-grid-style-3 card-style-full-image">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage8/sp7.png" alt="Ecom"></a>
                    </div>
                    <div class="info-right">
                      <div class="row"> 
                        <div class="col-6"> <span class="font-xs color-gray-500">Benjamin Graham</span></div>
                ...
                <div class="card-grid-style-3 card-style-full-image">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage8/sp8.png" alt="Ecom"></a>
                    </div>
                    <div class="info-right">
                      <div class="row"> 
                        <div class="col-6"> <span class="font-xs color-gray-500">Benjamin Graham</span></div>
                ...
                <div class="card-grid-style-3 card-style-full-image">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage8/sp9.png" alt="Ecom"></a>
                    </div>
                    <div class="info-right">
                      <div class="row"> 
                        <div class="col-6"> <span class="font-xs color-gray-500">Benjamin Graham</span></div>
                ...
                <div class="card-grid-style-3 card-style-full-image">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.php" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="shop-compare.php" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="shop-single-product-3.php"><img src="assets/imgs/page/homepage8/sp10.png" alt="Ecom"></a>
                    </div>
                    <div class="info-right">
                      <div class="row"> 
                        <div class="col-6"> <span class="font-xs color-gray-500">Benjamin Graham</span></div>
                              ...
                              <div class="image-box">
                                <div class="box-swiper">
                                  <div class="swiper-container swiper-tab" data-index="1">
                                    <div class="swiper-wrapper pt-5">
                                      <div class="swiper-slide"><img src="assets/imgs/page/homepage1/smartwatches.png" alt="Ecom"></div>
                                      <div class="swiper-slide"><img src="assets/imgs/page/homepage1/imgsp4.png" alt="Ecom"></div>
                      ...
                      <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                          <div class="card-grid-style-2">
                            ...
                            <div class="image-box"><a href="shop-single-product.php"><img src="assets/imgs/page/homepage8/book1.png" alt="Ecom"></a></div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                          <div class="card-grid-style-2">
                            ...
                            <div class="image-box"><a href="shop-single-product.php"><img src="assets/imgs/page/homepage8/book2.png" alt="Ecom"></a></div>
                            <div class="info-right"><span class="font-xs color-gray-500">Steven Job</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Eight Unconventional CEOs and Their Radically Rational Blueprint for Success</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2556.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                          <div class="card-grid-style-2">
                            ...
                            <div class="image-box"><a href="shop-single-product.php"><img src="assets/imgs/page/homepage8/book3.png" alt="Ecom"></a></div>
                            <div class="info-right"><span class="font-xs color-gray-500">Steven Job</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Eight Unconventional CEOs and Their Radically Rational Blueprint for Success</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2556.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                          <div class="card-grid-style-2">
                            ...
                            <div class="image-box"><a href="shop-single-product.php"><img src="assets/imgs/page/homepage8/book4.png" alt="Ecom"></a></div>
                            <div class="info-right"><span class="font-xs color-gray-500">Steven Job</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Eight Unconventional CEOs and Their Radically Rational Blueprint for Success</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2556.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                          <div class="card-grid-style-2">
                            <label class="label font-xs color-gray-500 bg-danger">Hot</label>
                            <div class="image-box"><a href="shop-single-product.php"><img src="assets/imgs/page/homepage8/book5.png" alt="Ecom"></a></div>
                            <div class="info-right"><span class="font-xs color-gray-500">Steven Job</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Eight Unconventional CEOs and Their Radically Rational Blueprint for Success</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2556.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                          <div class="card-grid-style-2">
                            <label class="label font-xs color-gray-500 bg-success">New</label>
                            <div class="image-box"><a href="shop-single-product.php"><img src="assets/imgs/page/homepage8/book6.png" alt="Ecom"></a></div>
                            <div class="info-right"><span class="font-xs color-gray-500">Steven Job</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Eight Unconventional CEOs and Their Radically Rational Blueprint for Success</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2556.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                          <div class="card-grid-style-2">
                            ...
                            <div class="image-box"><a href="shop-single-product.php"><img src="assets/imgs/page/homepage8/book7.png" alt="Ecom"></a></div>
                            <div class="info-right"><span class="font-xs color-gray-500">Steven Job</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Eight Unconventional CEOs and Their Radically Rational Blueprint for Success</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2556.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                          <div class="card-grid-style-2">
                            <label class="label font-xs color-gray-500 bg-success">New</label>
                            <div class="image-box"><a href="shop-single-product.php"><img src="assets/imgs/page/homepage8/book8.png" alt="Ecom"></a></div>
                            <div class="info-right"><span class="font-xs color-gray-500">Steven Job</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Eight Unconventional CEOs and Their Radically Rational Blueprint for Success</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2556.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                          <div class="card-grid-style-2">
                            <label class="label font-xs color-gray-500 bg-danger">Hot</label>
                            <div class="image-box"><a href="shop-single-product.php"><img src="assets/imgs/page/homepage8/book9.png" alt="Ecom"></a></div>
                            <div class="info-right"><span class="font-xs color-gray-500">Steven Job</span><br><a class="color-brand-3 font-sm-bold" href="shop-single-product.php">Eight Unconventional CEOs and Their Radically Rational Blueprint for Success</a>
                              <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><img src="assets/imgs/template/icons/star.svg" alt="Ecom"><span class="font-xs color-gray-500">(65)</span></div>
                              <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">$2556.3</strong><span class="color-gray-500 price-line">$3225.6</span></div>
                            </div>
