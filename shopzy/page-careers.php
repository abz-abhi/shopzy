        ...
        <div class="breadcrumbs-div">
          <div class="container">
            <ul class="breadcrumb">
              ...
              <li><a class="font-xs color-gray-500" href="page-term.php">Careers</a></li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-10 mx-auto page-content">
              <h2 class="text-center mb-20">Work with us</h2><img class="mb-30" src="assets/imgs/page/about/team-2.jpg" alt="Ecom">
