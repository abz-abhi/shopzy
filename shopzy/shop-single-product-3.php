      ...
      <div class="perfect-scroll">
        ...
        <div class="mobile-banner">
          <div class="bg-5 block-iphone">
            ...
            <a class="btn btn-arrow" href="shop-grid.php">learn more</a>
          </div>
        </div>
...
<main class="main">
    ...
    <div class="breadcrumbs-div">
      <div class="container">
        <ul class="breadcrumb">
          ...
          <li>
            <a class="font-xs color-gray-500" href="shop-grid.php"
              >Electronics</a
            >
          </li>
          <li>
  ...
  <section class="section-box shop-template">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3 class="color-brand-3 mb-5 mw-80">
            Samsung Galaxy S22 Ultra 5G 128/256GB SM-S906U1 Unlocked Cell Phones
            All Colors - Good Condition
          </h3>
          <div class="row">
            <div
              class="col-xl-6 col-lg-7 col-md-8 col-sm-7 text-center text-sm-start mb-mobile"
            >
              ...
              >
                Ecom Tech</a
              >
              <div class="rating mt-5 d-inline-block mr-20">
              ...
              <div class="sku-product d-inline-block">
                <span class="font-sm color-brand-3 font-medium">SKU:</span
                ><span class="font-sm color-gray-500"> EcomTech13689</span>
              </div>
            </div>
            <div
              class="col-xl-6 col-lg-5 col-md-4 col-sm-5 text-center text-sm-end"
            >
              <div class="d-inline-block">
                <a class="mr-20" href="shop-wishlist.php"
                  ><span
                    class="btn btn-wishlist mr-5 opacity-100 transform-none"
                  ></span
                  ><span class="font-md color-gray-900"
                ...
                <div class="d-inline-block align-middle ml-50">
                  <div class="share-link">
                    <span
                      class="font-md-bold color-brand-3 mr-15 d-none d-lg-inline-block"
                      >Share</span
          ...
          <div class="row">
            <div class="col-lg-7 col-md-7 mb-30">
              ...
              <div class="box-progress-product mt-15 mb-20">
                ...
                <span class="font-xs color-gray-500">Sold: 135/320</span>
              </div>
              ...
              <div class="box-product-color">
                ...
                <ul class="list-colors">
                  <li class="disabled">
                    <img
                      src="assets/imgs/page/product/img-thumb.png"
                      alt="Ecom"
                      title="Pink"
                    />
                  </li>
            ...
            <div class="col-lg-5 col-md-5">
              <div class="pl-30 pl-mb-0">
                <div class="box-featured-product">
                  <div class="item-featured">
                    <div class="featured-icon">
                      <img
                        src="assets/imgs/page/product/delivery.svg"
                        alt="Ecom"
                      />
                    </div>
                    <div class="featured-info">
                      <span class="font-sm-bold color-gray-1000"
                        >Free Delivery</span
                      >
                      <p class="font-sm color-gray-500 font-medium">
                  ...
                  <div class="item-featured">
                    <div class="featured-icon">
                      <img
                        src="assets/imgs/page/product/support.svg"
                        alt="Ecom"
                      />
                    </div>
                    <div class="featured-info">
                  ...
                  <div class="item-featured">
                    <div class="featured-icon">
                      <img
                        src="assets/imgs/page/product/return.svg"
                        alt="Ecom"
                      />
                    </div>
                    <div class="featured-info">
                  ...
                  <div class="item-featured">
                    <div class="featured-icon">
                      <img
                        src="assets/imgs/page/product/payment.svg"
                        alt="Ecom"
                      />
                    </div>
                    <div class="featured-info">
                ...
                <div class="box-sidebar-product">
                  <div
                    class="banner-right h-500 text-center mb-30 banner-right-product"
                  >
                    <span class="text-no font-11">No.9</span>
                    <h5 class="font-md-bold mt-10">
                      Sensitive Touch<br class="d-none d-lg-block" />without
                      fingerprint
                    </h5>
                    <p class="text-desc font-xs mt-10">
      ...
      <div class="box-bought-together">
        <div class="box-product-bought box-product-bought-2">
          <div class="product-bought">
            <img src="assets/imgs/page/product/sp1.png" alt="Ecom" />
          </div>
          <div class="product-bought">
            <img src="assets/imgs/page/product/sp2.png" alt="Ecom" />
          </div>
          <div class="product-bought">
            <img src="assets/imgs/page/product/sp3.png" alt="Ecom" />
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-7 col-sm-12">
          <h3 class="color-white">
            Subscrible &amp; Get <span class="color-warning">10%</span> Discount
          </h3>
